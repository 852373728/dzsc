...
<body>
	...
	<input id="yeMianPanDing"  type="hidden" value="1"/><!-- 当前页面的判定 -->
	<div class="crumbs">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="collapse in" id="zongLei">
					 	<div>
					   		...
					   		<dl>
					   			<dt>处方类型：</dt>
					   			<dd>
					   				<div class="morecate"><a class="zhankaiShouqi_a" role="button" data-toggle="collapse" href="#cflxb" aria-expanded="false" aria-controls="cflxb">展开</a></div>
					   				<ul class="zhankaiShouqi collapse" id="cflxb">
					   					<c:forEach items="${xzList }" var="cflxb">
					   					<li><a class="condition" adress="xzmc=${cflxb.xzmc }">${cflxb.xzmc }</a></li>
					   					</c:forEach>
					   				</ul>
					   			</dd>
					   		</dl>
					   		<dl>
					   			<dt>医保类型：</dt>
					   			<dd>
					   				<div class="morecate"><a class="zhankaiShouqi_a" role="button" data-toggle="collapse" href="#yblxb" aria-expanded="false" aria-controls="yblxb">展开</a></div>
					   				<ul class="zhankaiShouqi collapse" id="yblxb">
					   					<c:forEach items="${ylList }" var="yblxb">
					   					<c:if test="${yblxb.ylmc!='' }">
					   					<li><a class="condition" adress="ylmc=${yblxb.ylmc }类医保">${yblxb.ylmc }类医保</a></li>
					   					</c:if>
					   					</c:forEach>
					   				</ul>
					   			</dd>
					...
					<div id="list_view" class="no_img_list">
						...
						<c:forEach items="${spkList }" var="spk" varStatus="status">
							...
							<dl class="list_info goods_item_info ">
								...
								<dd class="first_dd">
									...
									<p class="company"><a target="_blank" style="color: black;" href="kegong.html?SCCJ1=${spk.SCCJ1 }">${spk.SCCJ1 }</a></p>
								</dd>
								<dd class="second_dd">
									<p>
									...
									<p class="big-none vip-price"><span class="no-none">有效期：</span>${spk.yxq }</p>
									<p class="big-none">
						...
						<div  class="floatRight feny">
							...
							<div class="page_jump_btn">
								<a href="javascript:;" onclick="page_jump_btn('kegong')"></a>
							</div>
